...
`;function te(){const{address:e}=Y(),{invitedInRound:t,rank:n,invited:a,inviter:r,totalPay:i}=q(),s=k(),o=g.exports.useMemo((()=>{if(i.gt(0))return r;const e=new URLSearchParams(s.search).get("r");return e&&h(e)?e:E}),[i,r]),c=`${window.location.protocol}//${window.location.host}${void 0!==e?`/?r=${e}`:""}`;return l.createElement(ne,null,l.createElement("div",{className:"global_panel panel_mg"},l.createElement("img",{src:B("results_round_bg.png")}),l.createElement("div",{className:"result_view"},l.createElement("div",{className:"result_num"},l.createElement("div",null,t),l.createElement("div",null,n)),l.createElement("div",{className:"view_ranking_btn"},l.createElement("button",{className:"offset_correction",onClick:()=>{L("ranking")}},"view ranking"))),l.createElement("div",{className:"invitation"},l.createElement("div",{className:"invit_item offset_correction"},l.createElement("img",{src:B("my_invitation_link.png")}),l.createElement("div",{className:"invit_txt"},c)),l.createElement("div",{className:"invit_item offset_correction"},l.createElement("img",{src:B("my_invitation_num.png")}),l.createElement("div",{className:"invit_txt num"},a)),l.createElement("div",{className:"invit_item offset_correction"},l.createElement("img",{src:B("my_inviter.png")}),l.createElement("div",{className:"invit_txt"},o)),l.createElement("div",{className:"copy_btn"},l.createElement("button",{className:"offset_correction",onClick:()=>{navigator.clipboard.writeText(c),Q.success("Copy successfully!")}},"copy my link")))))}const ne=p.div`
  overflow: hidden;
...
`;const pe=p.div`
  ...
  background-size: cover;
`;const ge=[{path:"/",exact:!0,component:function(){return l.createElement(pe,null,l.createElement($,null),l.createElement(te,null),l.createElement(ie,null),l.createElement(oe,null),l.createElement(le,null),l.createElement(ue,null))}}].map(((e,t)=>{const n=e,{component:s}=n,c=((e,t)=>{var n={};for(var s in e)r.call(e,s)&&t.indexOf(s)<0&&(n[s]=e[s]);if(null!=e&&a)for(var s of a(e))t.indexOf(s)<0&&i.call(e,s)&&(n[s]=e[s]);return n})(n,["component"]);let m=s;return l.createElement(Z,null,l.createElement(C,o({key:t},c),l.createElement(m,null),l.createElement(Q,null)))}));function be(){return l.createElement(I,null,ge)}T.render(l.createElement(be,null),document.getElementById("root"));
